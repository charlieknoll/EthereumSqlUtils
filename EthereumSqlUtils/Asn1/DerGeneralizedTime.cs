...
namespace EthereumSqlUtils.Asn1
{
        ...
        : Asn1Object
    {
        ...
        public DateTime ToDateTime()
        {
            ...
            if(CultureInfo.InvariantCulture.CompareInfo.IsSuffix(d, "Z", CompareOptions.Ordinal))
            ...
            else if (time.IndexOf('-') > 0 || time.IndexOf('+') > 0)
            {
                ...
                if (HasFractionalSeconds)
                {
                    int fCount = CultureInfo.InvariantCulture.CompareInfo.IndexOf(d, "GMT", CompareOptions.Ordinal)- 1 - d.IndexOf('.');// Platform.IndexOf(d, "GMT") - 1 - d.IndexOf('.');
