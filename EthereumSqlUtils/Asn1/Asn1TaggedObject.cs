...
//        internal bool           empty;
			...
			object obj)
		{
			...
			throw new ArgumentException("Unknown object in GetInstance: " + obj.GetType().Name);
		}
...
//				&& this.empty == other.empty
				...
				&& object.Equals(GetObject(), other.GetObject());
		}
...
//			code ^= explicitly.GetHashCode();
		...
		*/
			...
			bool	isExplicit)
		{
		    ...
		    throw
		        new NotImplementedException("implicit tagging for tag: " +
		                                    tag); //Platform.CreateNotImplementedException("implicit tagging for tag: " + tag);
		}
