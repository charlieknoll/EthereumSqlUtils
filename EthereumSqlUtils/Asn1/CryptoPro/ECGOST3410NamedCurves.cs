...
namespace EthereumSqlUtils.Asn1.CryptoPro
{
    /**
    ...
    */
    public sealed class ECGost3410NamedCurves
    {
        ...
        internal static readonly IDictionary objIds = new Dictionary<object, object>();
        internal static readonly IDictionary parameters = new Dictionary<object, object>();
        internal static readonly IDictionary names = new Dictionary<object, object>();
