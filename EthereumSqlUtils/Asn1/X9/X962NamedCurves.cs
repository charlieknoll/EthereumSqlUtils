...
using EthereumSqlUtils.Util.Collections;
    ...
    public sealed class X962NamedCurves
    {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(cFp192v1,
                        Util.Encoders.Hex.Decode("03188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012")),
                    n, h,
                    Util.Encoders.Hex.Decode("3045AE6FC8422f64ED579528D38120EAE12196D5"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(cFp192v2,
                        Util.Encoders.Hex.Decode("03eea2bae7e1497842f2de7769cfe9c989c072ad696f48034a")),
                    n, h,
                    Util.Encoders.Hex.Decode("31a92ee2029fd10d901b113e990710f0d21ac6b6"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(cFp192v3,
                        Util.Encoders.Hex.Decode("027d29778100c65a1da1783716588dce2b8b4aee8e228f1896")),
                    n, h,
                    Util.Encoders.Hex.Decode("c469684435deb378c4b65ca9591e2a5763059a2e"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(cFp239v1,
                        Util.Encoders.Hex.Decode("020ffa963cdca8816ccc33b8642bedf905c3d358573d3f27fbbd3b3cb9aaaf")),
                    n, h,
                    Util.Encoders.Hex.Decode("e43bb460f0b80cc0c0b075798e948060f8321b7d"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(cFp239v2,
                        Util.Encoders.Hex.Decode("0238af09d98727705120c921bb5e9e26296a3cdcf2f35757a0eafd87b830e7")),
                    n, h,
                    Util.Encoders.Hex.Decode("e8b4011604095303ca3b8099982be09fcb9ae616"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(cFp239v3,
                        Util.Encoders.Hex.Decode("036768ae8e18bb92cfcf005c949aa2c6d94853d0e660bbf854b1c9505fe95a")),
                    n, h,
                    Util.Encoders.Hex.Decode("7d7374168ffe3471b60a857686a19475d3bfa2ff"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(cFp256v1,
                        Util.Encoders.Hex.Decode("036b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296")),
                    n, h,
                    Util.Encoders.Hex.Decode("c49d360886e704936a6678e1139d26b7819f7e90"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m163v1,
                        Util.Encoders.Hex.Decode("0307AF69989546103D79329FCC3D74880F33BBE803CB")),
                    n, h,
                    Util.Encoders.Hex.Decode("D2C0FB15760860DEF1EEF4D696E6768756151754"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m163v2,
                        Util.Encoders.Hex.Decode("030024266E4EB5106D0A964D92C4860E2671DB9B6CC5")),
                    n, h,
                    null);
            }
        }
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    c2m163v3,
                    new X9ECPoint(c2m163v3, Util.Encoders.Hex.Decode("0202F9F87B7C574D0BDECF8A22E6524775F98CDEBDCB")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m176w1,
                        Util.Encoders.Hex.Decode("038D16C2866798B600F9F08BB4A8E860F3298CE04A5798")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m191v1,
                        Util.Encoders.Hex.Decode("0236B3DAF8A23206F9C4F299D7B21A9C369137F2C84AE1AA0D")),
                    n, h,
                    Util.Encoders.Hex.Decode("4E13CA542744D696E67687561517552F279A8C84"));
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m191v2,
                        Util.Encoders.Hex.Decode("023809B2B7CC1B28CC5A87926AAD83FD28789E81E2C9E3BF10")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m191v3,
                        Util.Encoders.Hex.Decode("03375D4CE24FDE434489DE8746E71786015009E66E38A926DD")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m208w1,
                        Util.Encoders.Hex.Decode("0289FDFBE4ABE193DF9559ECF07AC0CE78554E2784EB8C1ED1A57A")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m239v1,
                        Util.Encoders.Hex.Decode("0257927098FA932E7C0A96D3FD5B706EF7E5F5C156E16B7E7C86038552E91D")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m239v2,
                        Util.Encoders.Hex.Decode("0228F9D04E900069C8DC47A08534FE76D2B900B7D7EF31F5709F200C4CA205")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m239v3,
                        Util.Encoders.Hex.Decode("0370F6E9D04D289C4E89913CE3530BFDE903977D42B146D539BF1BDE4E9C92")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m272w1,
                        Util.Encoders.Hex.Decode("026108BABB2CEEBCF787058A056CBE0CFE622D7723A289E08A07AE13EF0D10D171DD8D")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m304w1,
                        Util.Encoders.Hex.Decode("02197B07845E9BE2D96ADB0F5F3C7F2CFFBD7A3EB8B6FEC35C7FD67F26DDF6285A644F740A2614")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m359v1,
                        Util.Encoders.Hex.Decode("033C258EF3047767E7EDE0F1FDAA79DAEE3841366A132E163ACED4ED2401DF9C6BDCDE98E8E707C07A2239B1B097")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m368w1,
                        Util.Encoders.Hex.Decode("021085E2755381DCCCE3C1557AFA10C2F0C0C2825646C5B34A394CBCFA8BC16B22E7E789E927BE216F02E1FB136A5F")),
                    n, h,
                    null);
            }
        }
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                return new X9ECParameters(
                    ...
                    new X9ECPoint(c2m431r1,
                        Util.Encoders.Hex.Decode("02120FC05D3C67A99DE161D2F4092622FECA701BE4F50F4758714E8A87BBF2A658EF8C21E7C5EFE965361F6C2999C0C247B0DBD70CE6B7")),
                    n, h,
                    null);
            }
        }

        private static readonly IDictionary objIds = new Dictionary<object, object>();
        private static readonly IDictionary curves = new Dictionary<object, object>();
        private static readonly IDictionary names = new Dictionary<object, object>();
        ...
        {
            objIds.Add(name.ToUpper(CultureInfo.InvariantCulture), oid);
            names.Add(oid, name);
