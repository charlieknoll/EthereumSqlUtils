...
using EthereumSqlUtils.Crypto;
using EthereumSqlUtils.Crypto.Agreement;
using EthereumSqlUtils.Crypto.Generators;
using EthereumSqlUtils.Crypto.Paramaters;
using EthereumSqlUtils.Hex.HexConvertors.Extensions;
using EthereumSqlUtils.RLP;
using EthereumSqlUtils.Security;
using EthereumSqlUtils.Signer.Crypto;
using EthereumSqlUtils.Util;


namespace EthereumSqlUtils.Signer
{
    public class EthECKey
    {
        private static readonly SecureRandom SecureRandom = new SecureRandom();
        //private static readonly SecureRandom SecureRandom = null;
        public static readonly byte DEFAULT_PREFIX = 0x04;
