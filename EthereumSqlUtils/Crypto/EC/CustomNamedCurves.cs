...
namespace EthereumSqlUtils.Crypto.EC
{
    public sealed class CustomNamedCurves
    {
        ...
        {
            return new BigInteger(1, EthereumSqlUtils.Util.Encoders.Hex.Decode(hex));
        }
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                 ...
                 */
                X9ECPoint G = new X9ECPoint(curve, Util.Encoders.Hex.Decode("04"
        ...
        //    protected override X9ECParameters CreateParameters()
        //    {
        //        byte[] S = Util.Encoders.Hex.Decode("000E0D4D696E6768756151750CC03A4473D03679");
        ...
        private static readonly IDictionary nameToCurve = new Dictionary<object, object>();
        private static readonly IDictionary nameToOid = new Dictionary<object, object>();
        private static readonly IDictionary oidToCurve = new Dictionary<object, object>();
        private static readonly IDictionary oidToName = new Dictionary<object, object>();
        private static readonly IList names = new List<object>();
        ...
        {
            X9ECParametersHolder holder = (X9ECParametersHolder)nameToCurve[name.ToUpper(CultureInfo.InvariantCulture)];
        ...
        {
            return (DerObjectIdentifier)nameToOid[name.ToUpper(CultureInfo.InvariantCulture)];
        }
