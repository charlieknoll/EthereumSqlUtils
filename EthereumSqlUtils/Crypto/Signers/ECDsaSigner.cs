...
using ECMultiplier = EthereumSqlUtils.Math.EC.ECMultiplier;

namespace EthereumSqlUtils.Crypto.Signers
{
    /**
        ...
        : IDsa
    {
        ...
        public virtual BigInteger[] GenerateSignature(byte[] message)
        {
            ...
            AbstractECMultiplier basePointMultiplier = CreateBasePointMultiplier();
        ...
        protected virtual AbstractECMultiplier CreateBasePointMultiplier()
        {
