using EthereumSqlUtils.Math.Raw;

namespace EthereumSqlUtils.Math.EC.Custom.Djb
{
        ...
        : AbstractFpCurve
    {
            ...
            : base(q)
        {
            ...
            this.m_a = FromBigInteger(new BigInteger(1,
                Util.Encoders.Hex.Decode("2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA984914A144")));
            this.m_b = FromBigInteger(new BigInteger(1,
                Util.Encoders.Hex.Decode("7B425ED097B425ED097B425ED097B425ED097B425ED097B4260B5E9C7710C864")));
            this.m_order = new BigInteger(1, Util.Encoders.Hex.Decode("1000000000000000000000000000000014DEF9DEA2F79CD65812631A5CF5D3ED"));
