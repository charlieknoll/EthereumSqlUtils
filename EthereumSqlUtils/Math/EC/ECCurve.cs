...
using EthereumSqlUtils.Math.EC.Abc;
using EthereumSqlUtils.Math.EC.Endo;
using EthereumSqlUtils.Math.EC.Multiplier;
using EthereumSqlUtils.Math.Field;
using EthereumSqlUtils.Util;

namespace EthereumSqlUtils.Math.EC
{
    ...
    public abstract class ECCurve
    {
        ...
        public class Config
        {
            ...
            protected AbstractECMultiplier multiplier;

            internal Config(ECCurve outer, int coord, ECEndomorphism endomorphism, AbstractECMultiplier multiplier)
            {
                this.outer = outer;
                this.coord = coord;
            ...
            public Config SetMultiplier(AbstractECMultiplier multiplier)
            {
                this.multiplier = multiplier;
                return this;
            }
        ...
        protected AbstractECMultiplier m_multiplier = null;
        ...
        protected virtual AbstractECMultiplier CreateDefaultMultiplier()
        {
         ...
         */
        public virtual AbstractECMultiplier GetMultiplier()
        {
            //TODO CEK Make sure this  ok
            //lock (this)
            //{
        ...
        : AbstractF2mCurve
    {
        ...
        protected override AbstractECMultiplier CreateDefaultMultiplier()
        {
            if (IsKoblitz)
            {
